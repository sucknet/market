...
export type PluginArgs = {
    ...
    __kind: 'PermanentFreezeExecute';
    fields: [PermanentFreezeExecuteArgs];
};
...
export declare function plugin(kind: 'PermanentFreezeExecute', data: GetDataEnumKindContent<PluginArgs, 'PermanentFreezeExecute'>['fields']): GetDataEnumKind<PluginArgs, 'PermanentFreezeExecute'>;
