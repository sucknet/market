...
export declare function getExecuteV1InstructionDataSerializer(): Serializer<ExecuteV1InstructionDataArgs, ExecuteV1InstructionData>;
export type ExecuteV1InstructionArgs = ExecuteV1InstructionDataArgs;
export declare function executeV1(context: Pick<Context, 'eddsa' | 'payer' | 'programs'>, input: ExecuteV1InstructionAccounts & ExecuteV1InstructionArgs): TransactionBuilder;
